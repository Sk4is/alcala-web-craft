...
const Contacto: React.FC = () => {
  ...
  `;
    ...
    try {
      ...
      if (result.success) {
        alert(
          "¡Enviado! Hemos enviado una copia a tu correo. Te contactaremos pronto."
        );
        setFormData({
          name: "",
          email: "",
        ...
        alert(
          "Error al enviar el correo. Comprueba la configuración del remitente."
        );
      }
    } catch (error) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contacto | Diseño Web Alcalá de Henares - Presupuesto Gratuito
        </title>
        <meta
          name="description"
          content="Contacta con nuestro equipo para tu proyecto de diseño, desarrollo o posicionamiento web en Alcalá de Henares. Presupuesto gratuito y sin compromiso."
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://disenowebalcaladehenares.es/contacto.html"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Página de contacto para solicitar presupuesto de diseño web en Alcalá de Henares",
            ...
            <div className="max-w-[1250px] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                  ¿Tienes un proyecto en mente? Cuéntanos qué necesitas y
                  crearemos un presupuesto personalizado y gratuito.
                </p>
              </div>
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        <span className="text-2xl mr-4" aria-hidden>
                          📍
                        </span>
                        <div>
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <li key={item} className="flex items-center">
                          <span className="text-green-500 mr-3" aria-hidden>
                            ✓
                          </span>
