          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                Diseño Web para <span className="text-blue-600">Dentistas</span>{" "}
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20 py-12">
        ...
        <section className="mb-16">
          <div className="prose prose-lg max-w-none">
            <p className="text-lg leading-loose text-gray-700 mb-8">
              ...
              Henares es un reto que requiere una estrategia profesional. El 78%
              de los pacientes buscan información sobre dentistas en Google
              antes de pedir cita, y una presencia digital deficiente puede
              significar la pérdida de pacientes potenciales que acaban
            ...
            <p className="text-lg leading-loose text-gray-700 mb-8">
              ...
              referente local. El diseño web para dentistas en Alcalá de Henares
              debe transmitir profesionalidad, ser completamente accesible y
              cumplir con la normativa sanitaria digital.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-2 hover:border-primary-200 transition-colors">
              ...
              <CardContent>
                <p className="text-gray-700 leading-loose">
                  ...
                  primeras posiciones cuando buscan "dentista Alcalá de Henares"
                  puede incrementar las consultas hasta un 200%.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-primary-200 transition-colors">
              ...
              <CardContent>
                <p className="text-gray-700 leading-loose">
                  Tu web trabaja 24/7 captando pacientes nuevos, facilitando el
                  contacto y proporcionando información sobre tratamientos y
                  especialidades.
                </p>
              </CardContent>
            </Card>
        ...
        <section className="mb-16">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="actualizacion">
              ...
              <AccordionContent>
                <p className="text-gray-700 leading-loose">
                  Sí, tu web incluye un panel de administración intuitivo donde
                  podrás actualizar información sobre tratamientos, precios,
                  horarios, y añadir nuevo contenido. Te proporcionamos
                  formación completa y manual de uso específico para clínicas
                  dentales.
                </p>
              </AccordionContent>
            </AccordionItem>
        ...
        >
          ...
          <p className="text-xl mb-12 opacity-90 max-w-3xl mx-auto">
            Solicita hoy tu web para clínica dental en Alcalá de Henares y gana
            visibilidad profesional con una presencia digital que transmita
            confianza médica y cumpla todos los estándares legales.
          </p>
